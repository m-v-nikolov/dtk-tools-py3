...
def populate_run_arguments(subparsers, func=None):
    ...
    parser_run.add_argument('-a', '--analyzer', default=None, help='Specify an analyzer name or configuration to run upon completion (this operation is blocking) (see dtk analyze-list).')
...
def populate_analyze_arguments(subparsers, func=None):
    ...
    parser_analyze.add_argument('-bn', '--batch_name', dest='batch_name', default=None, nargs=1, help='Use Batch Name for analyze.')
...
def populate_createbatch_arguments(subparsers, func=None):
    ...
    parser_createbatch.add_argument('-bn', '--batch_name', dest='batch_name', default=None, nargs='?', help='Use Batch Name.')
...
def populate_listbatch_arguments(subparsers, func=None):
    ...
    parser_listbatch.add_argument('-id', '--batch_id', dest='batch_id', default=None, nargs='?', help='Batch ID.')
...
def populate_clearbatch_arguments(subparsers, func=None):
    parser_clearbatch = subparsers.add_parser('clear_batch', help='Remove all associated experiments.')
...
def populate_deletebatch_arguments(subparsers, func=None):
    ...
    parser_deletebatch.add_argument('-id', '--batch_id', dest='batch_id', default=None, nargs='?', help='Batch ID.')
